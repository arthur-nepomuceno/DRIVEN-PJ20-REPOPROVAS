...
-- CreateIndex
CREATE UNIQUE INDEX "categoriess_name_key" ON "categoriess"("name");
...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "categoriess"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
